...
<body>
    ...
    if (isset($_POST['register'])) {
        ...
        $sql = "INSERT INTO user_registration (user_name, mail_ID, phone_No, city, password, confirmPassword, email_verified, verification_code) VALUES ('$username', '$email', '$phone', '$city', '$hashedPassword', '$hashedConfirmPassword', 0, '$verificationCode')"; // Set email_verified to 0 by default
