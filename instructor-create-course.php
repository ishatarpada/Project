            ...
            <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3 user-list" aria-labelledby="profileDropdown">
              ...
              <li class="px-3 mb-3">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <p class="small m-0"><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'Guest'; ?></p>
                    <p class="small m-0"><?php echo isset($_SESSION['email']) ? $_SESSION['email'] : 'guest@example.com'; ?></p>
            ...
            <form action="instructor-add_course.php" method="POST" class="container my-2" enctype="multipart/form-data">
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control fw-normal" id="courseTitle" placeholder="course title" name="course_title" required>
                </div>
                <div class="col-12">
                  <label for="description" class="form-label fw-normal">Short Description</label>
                  <textarea type="text" class="form-control fw-normal" id="description" placeholder="Enter keyword" name="course_description" required></textarea>
                </div>
                <div class="col-md-6">
                  <label for="courseCategory" class="form-label fw-normal">Course Category</label>
                  <select class="form-select fw-normal" aria-label="Default select example" name="course_category" required>
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select fw-normal" aria-label="Default select example" name="course_level" required>
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select fw-normal" aria-label="Default select example" name="course_language" required>
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control fw-normal" type="text" placeholder="Enter course time" name="course_time" required>
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-normal">Total lecture</label>
                  <input class="form-control fw-normal" type="text" placeholder="Enter total lecture" name="total_lecture" required>
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-normal">Instructor Name</label>
                  <input class="form-control fw-normal" type="text" placeholder="Enter Instructor name" name="instructor" value="<?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'Guest'; ?>" required>
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-normal">Channel Name </label>
                  <input class="form-control fw-normal" type="text" placeholder="Enter channel name" name="channel_name" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control fw-normal" placeholder="Enter course price" name="course_price" required>
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-normal">Discount price</label>
                  <input class="form-control fw-normal" type="text" placeholder="Enter discount" name="discount_price" required>
                ...
                <div class="col-12">
                  ...
                  <div class="col-12 mt-4 mb-5">
                    ...
                    <input class="form-control text-secondary fw-medium" type="text" placeholder="Enter video url" name="video_url">
                  </div>
