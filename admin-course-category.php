      ...
      <div class="container-fluid my-2 mx-2 bg-light">
        <div class="title d-flex justify-content-between align-items-center">
          <h1 class="fw-bold m-0 p-2">
            Course
            <span
              class="bg-warning-subtle bg-opacity-10 text-warning-emphasis fw-semibold fs-5 px-3 py-1 rounded">5</span>
          </h1>
        ...
        <div class="row mx-5 g-3 align-items-center p-3 bg-body-tertiary justify-content-between">
          ...
          <div class="col-md-8 m-0">
            <form class="rounded position-relative">
              <input class="form-control bg-body py-2 fw-bold" type="search" name="search_query" placeholder="Search"
                aria-label="Search" />
              <button
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <h6 class="mb-0 ms-2 table-responsive-title fw-bolder">
                              <a href="#" class="text-dark-emphasis text-decoration-none">
                                <?php echo $row["instructor"]; ?></a>
                            </h6>
                          </div>
                        </td>
                        <!-- rating item -->
