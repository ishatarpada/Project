          ...
          <div class="nav mx-3 my-xl-0 flex-nowrap align-items-center">
            <div class="nav-item w-100">
              <form class="position-relative">
                <input class="form-control pe-5 bg-secondary bg-opacity-10 border-0" type="search" placeholder="Search"
                  aria-label="Search" />
          ...
          <div class="dropdown user-info ms-1 ms-lg-0 me-2 rounded-circle">
            <?php
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            $profile_picture = 'Assests/user-profile.png';
            ...
            <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside"
              ...
              <img class="avatar-img rounded-circle" src="<?php echo $profile_picture ?>" alt="avatar"
            ...
            <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3 user-list"
              ...
              <li class="px-3 mb-3">
                <div class="d-flex align-items-center">
                  <div class="avatar me-3">
                    <img class="avatar-img rounded-circle shadow img-fluid" src="<?php echo $profile_picture ?>"
              ...
              <li>
                <a class="dropdown-item" href="admin-profile.php"><i class="bi bi-person fa-fw me-4"></i>Edit
                  Profile</a>
              </li>
              <li>
                <a class="dropdown-item" href="admin-setting.php"><i class="bi bi-gear fa-fw me-4"></i>Account
                  Settings</a>
              </li>
              <li>
