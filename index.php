      ...
      <nav class="navbar navbar-expand-xl">
        <div class="container-fluid p-0 justify-content-between">
          ...
          <a class="navbar-brand fw-bold text-light logo-name" href="index.php">
            <img src="Assests/course.png" alt="Logo" width="100" height="50" class="d-inline-block align-text-top">
            <!-- MyCourses.io -->
          </a>
          <div class="phoneIcons mx-auto mt-2 d-flex justify-content-center align-items-center">
            ...
            <!-- cart icon -->
            <a href="cart.php"
              class="btn btn-transparent text-center text-decoration-none text-secondary fw-bolder p-1">
...
>>>>>>> 90daff459c2283f604a67b39815664c20386db26
                  <?php endif; ?>
                  <span class="visually-hidden">items in cart</span>
                </span>
              </i>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="icons mx-auto mb-2 mb-lg-0 mx-lg-4 my-2 d-flex justify-content-center align-items-center">
              ...
              <p class="m-0 d-flex align-items-center">
                <a href="notification.php" class="text-decoration-none text-light me-3 iconBtn"><i
                    class="bi bi-bell-fill fs-4 me-1"></i><span class="name fw-semibold">Notification</span>
                </a>
              </p>
              <p class="m-0 d-flex align-items-center">
...
>>>>>>> 90daff459c2283f604a67b39815664c20386db26
              ...
              <p class="m-0 d-flex align-items-center"><a href="login.html"
                  class="text-decoration-none text-light me-3 iconBtn"><i
                    class="bi bi-person-circle fs-4 me-1"></i><span class="name fw-semibold">Account</span>
                </a></p>
            </div>
...
>>>>>>> 90daff459c2283f604a67b39815664c20386db26
                ...
                <li><a class="dropdown-item" href="wishlist-course.php"><i class="bi bi-heart wishlistBtn me-4" fa-fw
                      me-4"></i>Wishlist</a>
                </li>
                <li>
                  <hr class="dropdown-divider">
                ...
                <li><a class="dropdown-item" href="notification.php"><i
...
=======
    ...
    <div class="container search-section bg-body-tertiary py-2 mt-4 border-rounded">
      <div class="row py-3">
        <div class="col-lg-4  my-auto">
          <form action="#">
            <input class="form-control pe-5 bg-transparent w-100 mx-auto" type="search"
              placeholder="Find courses, skills, software, etc" aria-label="Search">
          </form>
        </div>
    ...
    <div class="d-flex flex-nowrap p-0 continue-watching">
      <div class="continue-watching-part m-1 p-1">
        <div class="continue-img position-relative">
          <a href="unpaid-offline.php" class="text-decoration-none">
            <img src="Assests/continue-img-1.jpg" alt="" class="border rounded-2 position-absolute top-0 start-0"
              height="100%" width="100%">
            <i class="bi bi-three-dots-vertical fs-5 fw-bold text-light position-absolute top-0 mt-1 me-2 end-0"></i>
            <div class="progress position-absolute bottom-0 start-0 w-100" role="progressbar" aria-label="Basic example"
      ...
      <div class="continue-watching-part m-1 p-1">
        <a href="paid-offline.php" class="text-decoration-none">
          <div class="continue-img position-relative">
            <img src="Assests/continue-img-2.webp" alt="" class="border rounded-2 position-absolute top-0 start-0"
              height="100%" width="100%">
            <i class="bi bi-three-dots-vertical fs-5 fw-bold text-light position-absolute top-0 mt-1 me-2 end-0"></i>
            <div class="progress position-absolute bottom-0 start-0 w-100" role="progressbar" aria-label="Basic example"
              aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="height: 5px;">
      ...
      <div class="continue-watching-part m-1 p-1">
        <a href="unpaid-offline.php" class="text-decoration-none">
          <div class="continue-img position-relative">
            <img src="Assests/continue-img-3.jpg" alt="" class="border rounded-2 position-absolute top-0 start-0"
              height="100%" width="100%">
            <i class="bi bi-three-dots-vertical fs-5 fw-bold text-light position-absolute top-0 mt-1 me-2 end-0"></i>
            <div class="progress position-absolute bottom-0 start-0 w-100" role="progressbar" aria-label="Basic example"
              aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="height: 5px;">
  ...
  <div class="container-fluid my-4 courses-section" style="width: 95%; margin: auto;">
    ...
    <div class="course-categories">
      <ul
        class="nav nav-pills d-flex justify-content-between flex-nowrap mb-4 p-3 bg-success bg-opacity-10 rounded course-list"
        id="course-pills-tab" role="tablist" style="width: 95%; margin: auto;">
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5 active" id="course-pills-tab-1"
            data-bs-toggle="pill" data-bs-target="#course-pills-tabs-1" type="button" role="tab"
            aria-controls="course-pills-tabs-1" aria-selected="true" style="background-color: #146659;">Mobile App
            Development</button>
        </li>
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5" id="course-pills-tab-2" data-bs-toggle="pill"
            data-bs-target="#course-pills-tabs-2" type="button" role="tab" aria-controls="course-pills-tabs-2"
            aria-selected="false" tabindex="-1" style="background-color: #146659;">Cyber Security</button>
        </li>
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5" id="course-pills-tab-3" data-bs-toggle="pill"
            data-bs-target="#course-pills-tabs-3" type="button" role="tab" aria-controls="course-pills-tabs-3"
            aria-selected="false" tabindex="-1" style="background-color: #146659;">Artificial Intelligence</button>
        </li>
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5" id="course-pills-tab-4" data-bs-toggle="pill"
            data-bs-target="#course-pills-tabs-4" type="button" role="tab" aria-controls="course-pills-tabs-4"
            aria-selected="false" tabindex="-1" style="background-color: #146659;">DevOps</button>
        </li>
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5" id="course-pills-tab-5" data-bs-toggle="pill"
            data-bs-target="#course-pills-tabs-5" type="button" role="tab" aria-controls="course-pills-tabs-5"
            aria-selected="false" tabindex="-1" style="background-color: #146659;">Software Developer</button>
        </li>
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5" id="course-pills-tab-6" data-bs-toggle="pill"
            data-bs-target="#course-pills-tabs-6" type="button" role="tab" aria-controls="course-pills-tabs-6"
            aria-selected="false" tabindex="-1" style="background-color: #146659;">Web Developer</button>
        </li>
        <!-- Tab item -->
        <li class="text-light me-2 text-nowrap shadow-none border-0 my-0 me-sm-5 rounded" role="presentation">
          <button class="text-light py-2 px-3 border-0 rounded fs-5" id="course-pills-tab-7" data-bs-toggle="pill"
            data-bs-target="#course-pills-tabs-7" type="button" role="tab" aria-controls="course-pills-tabs-7"
            aria-selected="false" tabindex="-1" style="background-color: #146659;">Computing</button>
        </li>
      </ul>
    </div>
    <!-- Tabs END -->
    ...
    <div class="instructor-info d-flex">
      <div class="instructor-part mx-2 my-1">
        <div class="instructor position-relative">
          ...
          <div
            class="instructor-name bg-transparent position-absolute top-0 start-0 text-center d-flex justify-content-center align-items-end">
            <div>
