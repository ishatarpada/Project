...
<body>
  ...
  <!-- categories section -->
  <div class="container-fluid my-5 courses-section mx-auto" style="width: 95%;">
    <!-- Title -->
    <div class="row my-4">
  ...
  <div class="instructor-section container my-5">
    ...
    <div class="instructor-info d-flex">
      <div class="instructor-part mx-2 my-1">
        <div class="instructor position-relative">
          <div class="instructor-img position-absolute">
            <img src="https://plus.unsplash.com/premium_photo-1664300900349-afd61c20f8b8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cHJvZmVzc29yfGVufDB8fDB8fHww" alt="" class="" height="100%" width="100%">
          </div>
          <div
      ...
      <div class="instructor-part mx-2 my-1">
        <div class="instructor position-relative">
          <div class="instructor-img position-absolute">
            <img src="https://images.unsplash.com/flagged/photo-1574110906643-8311b0ce29d3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHByb2Zlc3NvcnxlbnwwfHwwfHx8MA%3D%3D" alt="" class="" height="100%" width="100%">
          </div>
          <div
            class="instructor-name bg-transparent position-absolute top-0 start-0 text-center d-flex justify-content-center align-items-end">
            <div>
