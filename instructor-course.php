        ...
        <div class="main bg-body-tertiary">
            ...
            <div class="container-fluid my-2 mx-2 bg-light">
                <div class="title d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary btn-lg me-5"><a href="instructor-create-course.php" class="text-decoration-none text-light">Create Course</a></button>
                </div>
            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-center align-items-center">
                                                                    <a href="instructor_course-detail.php?id=<?php echo $row['course_ID'] ?>" class="text-decoration-none btn fw-semibold mx-2 btn-lg" style="background-color: #15739867; color:#103c4e;">Details</a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <?php
