                            ...
                            <div class="custom-scrollbar">
                                <div class="os-padding">
                                    ...
                                    <div class="d-flex justify-content-between position-relative">
                                        <div class="d-sm-flex">
                                            <div class="icon-lg bg-success bg-opacity-10 text-success text-center rounded-2 flex-shrink-0  d-flex justify-content-center align-items-center me-2" style="height: 50px; width: 50px">
                                    ...
                                    <div class="d-flex justify-content-between position-relative">
                                        <div class="d-sm-flex">
                                            <div class="icon-lg bg-warning bg-opacity-10 text-warning text-center rounded-2 flex-shrink-0  d-flex justify-content-center align-items-center me-2" style="height: 50px; width: 50px">
                                    ...
                                    <div class="d-flex justify-content-between position-relative">
                                        <div class="d-sm-flex">
                                            <div class="icon-lg bg-info bg-opacity-10 text-info text-center rounded-2 flex-shrink-0  d-flex justify-content-center align-items-center me-2" style="height: 50px; width: 50px">
                                    ...
                                    <div class="d-flex justify-content-between position-relative">
                                        <div class="d-sm-flex">
                                            <div class="icon-lg bg-danger bg-opacity-10 text-danger text-center rounded-2 flex-shrink-0  d-flex justify-content-center align-items-center me-2" style="height: 50px; width: 50px">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between position-relative">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="avatar avatar-md flex-shrink-0 me-2" style="height: 50px; width: 50px">
                                        <img class="avatar-img rounded-circle" style="height: 50px; width: 50px" src="Assests/i-1.jpg" alt="avatar" />
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                        <h6 class="mb-0">
                                ...
                                <div class="d-sm-flex">
                                    ...
                                    <div class="avatar avatar-md flex-shrink-0 me-3">
                                        <div class="avatar-img rounded-circle bg-info bg-opacity-10 me-2" style="height: 50px; width: 50px">
                                            <span class="text-info position-absolute text-center top-25 start-0 translate-middle fw-bold ms-4 mt-4">DB</span>
                                        </div>
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                            ...
                            <div class="d-flex justify-content-between position-relative">
                                <div class="d-sm-flex">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-md flex-shrink-0 me-3">
                                        <div class="avatar-img rounded-circle bg-danger bg-opacity-10 me-2" style="height: 50px; width: 50px">
                                            <span class="text-danger position-absolute text-center top-25 start-0 translate-middle fw-bold ms-4 mt-4">WB</span>
                                        </div>
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                            ...
                            <div class="d-flex justify-content-between position-relative">
                                <div class="d-sm-flex">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-md flex-shrink-0 me-2" style="height: 50px; width: 50px">
                                        <img class="avatar-img rounded-circle" style="height: 50px; width: 50px" src="Assests/i-4.jpg" alt="avatar" />
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                        <h6 class="mb-0">
