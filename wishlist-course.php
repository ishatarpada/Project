          ...
          <div class="video-box m-2 rounded shadow" style="width: 350px;">
            <form action="manage_cart.php" method="post">
              <div class="video-img  position-relative" style="height: 225px; width: 350px;">
                <img src="<?php echo htmlspecialchars($item['Item_Img']); ?>" alt=""
                  class="border-0 position-absolute top-0 rounded" height=" 100%" width="100%">
                ...
                <div class="heart-icon position-absolute top-0 start-0 rounded-circle py-1 px-2 m-2">
                  <button
                    class="text-decoration-none text-danger btn btn-transparent m-0 p-0 border-0 outline-0 removeBtn"
                    type="submit" name="removeBtn">
                    <?php
              ...
              <div class="video-content  my-2">
                ...
                <div
                  class="course-price trending-course-price d-flex justify-content-start align-items-center fw-bold m-0 px-3 pt-1">
                ...
                <div class="d-flex justify-content-between px-2 mt-2">
                  <span class="h6 fw-light mb-0 fw-semibold"><i
                      class="bi bi-clock text-danger me-2"></i><?php echo  $item['Item_time']; ?></span>
                  <span class="h6 fw-light mb-0 fw-semibold"><i
                      class="bi bi-table text-warning me-2"></i><?php echo $item['Item_total_lecture']; ?>
                    lectures</span>
                </div>
              </div>
    ...
    <div class="join-part container-fluid position-relative my-2">
      ...
      <div class="row join-content position-absolute w-100">
        ...
        <div class="col-lg-2 m-auto subscribeBtn">
          <button type="button"
            class=" subscribe-button btn btn-secondary text-light border border-0">Subscribe</button>
        </div>
      </div>
    </div>
  </div>
