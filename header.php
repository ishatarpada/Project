            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="icons mx-auto mb-2 mb-lg-0 mx-lg-4 my-2 d-flex justify-content-center align-items-center">
                        ...
                        <a href="notification.php" class="text-decoration-none text-dark me-3 iconBtn"><i class="bi bi-bell-fill fs-4 me-1"></i><span class="name fw-medium">Notification</span></a>
                        <a href="cart.php" class="text-decoration-none text-dark me-3 iconBtn"><i class="bi bi-cart fs-3 me-2 position-relative">
                                <!-- Cart item count -->
                                <?php if ($cartItemCount > 0) : ?>
                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-danger" style="padding: 4px 8px;"><?php echo $cartItemCount; ?></span>
                                <?php endif; ?>
                            </i></a>
                        ...
                        <div class="dropdown user-info ms-1 ms-lg-0 me-2 rounded-circle">
                            <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img class="avatar-img rounded-circle" src="<?php echo $avatar; ?>" alt="avatar" height="50px" width="50px">
                            </a>
                            <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3 user-list" aria-labelledby="profileDropdown">
                                ...
                                <!-- Dropdown items -->
                                <li><a class="dropdown-item fw-medium" href="All-course.php"><i class="bi bi-laptop me-4"></i>My Courses</a></li>
                                <li><a class="dropdown-item fw-medium" href="cart.php"><i class="bi bi-cart fa-fw me-4"></i>My Cart</a></li>
                                <li><a class="dropdown-item fw-medium" href="wishlist-course.php"><i class="bi bi-heart wishlistBtn me-4" fa-fw me-4"></i>Wishlist</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                ...
                                <li><a class="dropdown-item fw-medium" href="notification.php"><i class="bi bi-bell fa-fw me-4"></i>notification</a>
                                </li>
                                <li><a class="dropdown-item fw-medium" href="help.php"><i class="bi bi-info-circle fa-fw me-4"></i>Help</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item fw-medium bg-danger-soft-hover" href="log-out.php"><i class="bi bi-power fa-fw me-4 text-danger"></i>
