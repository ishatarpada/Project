  ...
  <div class="wrapper">
    ...
    <div class="main bg-body-tertiary">
      ...
      <div class="row">
        <!-- left -->
        <div
          class="col-12 col-lg-7 d-md-flex align-items-center justify-content-center bg-success bg-opacity-10 vh-lg-100">
              ...
              <div class="container mt-5 border-0">
                <form class="row text-start g-3" action="send_message.php" method="POST" onsubmit="setReceiverId()">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="messageBody" rows="5" name="message" placeholder="Enter message"
                      required></textarea>
                  </div>
                  ...
                  <div class="d-flex justify-content-center align-items-center bg-success text-light">
                    ...
                    <button type="submit" name="send_message" class="btn btn-lg fw-bold text-light my-0">Send
                      Message</button>
                  </div>
