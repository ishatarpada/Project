            ...
            <div class="container my-5">
                ...
                <div class="card my-2">
                    <div class="card-body">
                        ...
                        ?>
                                <form action="update_course.php?id=<?php echo $row['course_ID'] ?>" method="POST" class="container my-2" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control fw-medium text-secondary" id="courseTitle" value="<?php echo $row["course_title"]; ?>" name="course_title" required>
                                        </div>
                                        <div class="col-12">
                                            <label for="description" class="form-label fw-bolder" style="font-size: 18px;">Short Description</label>
                                            <textarea type="text" class="form-control fw-medium text-secondary" id="description" name="course_description" required><?php echo $row["course_description"]; ?></textarea>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="courseCategory" class="form-label fw-bolder" style="font-size: 18px;">Course Category</label>
                                            <select class="form-select fw-medium text-secondary" aria-label="Default select example" name="course_category" required>
                                                <option value="" selected>Select Category</option>
                                                <option value="Cybersecurity" <?php if ($row["course_category"] == "Cybersecurity") echo "selected"; ?>>Cybersecurity</option>
                                                <option value="Artificial Intelligence" <?php if ($row["course_category"] == "Artificial Intelligence") echo "selected"; ?>>Artificial Intelligence</option>
                                                <option value="Mobile App Development" <?php if ($row["course_category"] == "Mobile App Development") echo "selected"; ?>>Mobile App Development</option>
                                                <option value="Software Developer" <?php if ($row["course_category"] == "Software Developer") echo "selected"; ?>>Software Developer</option>
                                                <option value="Web Developer" <?php if ($row["course_category"] == "Web Developer") echo "selected"; ?>>Web Developer</option>
                                                <option value="Data Analytics" <?php if ($row["course_category"] == "Data Analytics") echo "selected"; ?>>Data Analytics</option>
                                                <option value="Database" <?php if ($row["course_category"] == "Database") echo "selected"; ?>>Database</option>
                                                <option value="Graphics Design" <?php if ($row["course_category"] == "Graphics Design") echo "selected"; ?>>Graphics Design</option>
                                                <option value="Blockchain" <?php if ($row["course_category"] == "Blockchain") echo "selected"; ?>>Blockchain</option>
                                                <option value="DevOps" <?php if ($row["course_category"] == "DevOps") echo "selected"; ?>>DevOps</option>
                                                <option value="Maths & Logic" <?php if ($row["course_category"] == "Maths & Logic") echo "selected"; ?>>Maths & Logic</option>
                                                <option value="English" <?php if ($row["course_category"] == "English") echo "selected"; ?>>English</option>
                                                <option value="Fiance" <?php if ($row["course_category"] == "Fiance") echo "selected"; ?>>Fiance</option>
                                                <option value="Management" <?php if ($row["course_category"] == "Management") echo "selected"; ?>>Management</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="courseLevel" class="form-label fw-bolder" style="font-size: 18px;">Course Level</label>
                                            <select class="form-select fw-medium text-secondary" aria-label="Default select example" name="course_level" required>
                                                <option value="" selected>Select Course Level</option>
                                                <option value="Advance" <?php if ($row["course_level"] == "Advance") echo "selected"; ?>>Advance</option>
                                                <option value="All Level" <?php if ($row["course_level"] == "All Level") echo "selected"; ?>>All Level</option>
                                        ...
                                        <div class="col-md-6">
                                            <label for="courseLanguage" class="form-label fw-bolder" style="font-size: 18px;">Course Language</label>
                                            <select class="form-select fw-medium text-secondary" aria-label="Default select example" name="course_language" required>
                                                <option value="" selected>Select Course Language</option>
                                                <option value="French" <?php if ($row["course_language"] == "French") echo "selected"; ?>>French</option>
                                                <option value="English" <?php if ($row["course_language"] == "English") echo "selected"; ?>>English</option>
                                                <option value="Hindi" <?php if ($row["course_language"] == "Hindi") echo "selected"; ?>>Hindi</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control fw-medium text-secondary" type="text" value="<?php echo $row["course_time"]; ?>" name="course_time" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bolder" style="font-size: 18px;">Total lecture</label>
                                            <input class="form-control fw-medium text-secondary" type="text" value="<?php echo $row["total_lecture"]; ?>" name="total_lecture" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bolder" style="font-size: 18px;">Instructor Name</label>
                                            <input class="form-control fw-medium text-secondary" type="text" value="<?php echo $row["instructor"]; ?>" name="instructor" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bolder" style="font-size: 18px;">Channel Name </label>
                                            <input class="form-control fw-medium text-secondary" type="text" value="<?php echo $row["channel_name"]; ?>" name="channel_name" required>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-bolder" style="font-size: 18px;">Upload instructor image</label>
                                            <div class="input-group mb-3">
                                                <input type="file" class="form-control text-secondary" id="inputGroupFile01" name="instructor_img" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control fw-medium text-secondary" value="<?php echo $row["course_price"]; ?>" name="course_price" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bolder" style="font-size: 18px;">Discount price</label>
                                            <input class="form-control fw-medium text-secondary" type="text" value="<?php echo $row["course_discount_price"]; ?>" name="discount_price" required>
                                            ...
                                            <div class="text-center justify-content-center align-items-center p-4 p-sm-5 border border-2 border-secondary position-relative rounded-3" style="border-style: dashed; border-width: 2px;">
                                                ...
                                                <div>
                                                    ...
                                                    <label style="cursor:pointer;">
                                                        <span>
                                                            <input class="form-control stretched-link" type="file" name="course_img" id="image" accept="image/gif, image/jpeg, image/png" required>
                                                        </span>
                                                    </label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-12 mt-4 mb-5">
                                                ...
                                                <input class="form-control text-secondary fw-medium" type="text" value="<?php echo $row["video_url"]; ?>" name="video_url">
                                            </div>
