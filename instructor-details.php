...
<body>
                ...
                if (isset($_SESSION['username'])) {
                    ...
                    if ($result) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = 'http://localhost/courseregistration/instructor-dashboard.php';
                        });
                    </script>";
                    } else {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['uploadDetails'])) {
        ...
        $behance_ID = $_POST['behance_ID'];

        // Get the user's ID from the session (assuming you have stored it during login)
        $user_id = 4; // Change this as per your application's logic
